...
export interface GuideRef {
  tab: '/(tabs)/guide' | '/(tabs)/walkthrough';
  categoryId?: string;
  label: string;
}
...
export const MARKERS: MapPoint[] = [
...

  {
    ...
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Walkthrough' },
  },

  {
    ...
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Chapter 2' },
  },

  {
    ...
    description: 'A small but important rail stop on the Cumberland & Western line connecting Flat Iron Lake country to the north. Primarily a staging point for train robberies and supply runs rather than a full town.',
    services: ['General Store', 'Train Station'],
    chapter: 'Chapters 2–4',
    tip: 'A fence and telegram operator operate here — useful for offloading stolen goods between missions.',
    guideRef: { tab: '/(tabs)/guide', label: 'View Guide' },
  },

  {
    ...
    category: 'towns',
    region: 'West Elizabeth — Big Valley',
    description: 'A picturesque mountain town with a more refined character than Valentine. Home to a hotel and well-stocked shops. Micah Bell is arrested and jailed here after a post-Blackwater altercation.',
...

  {
    ...
    tip: 'Do NOT enter Blackwater as Arthur — the $300+ bounty will mean instant five-star wanted level. Safe for John in the Epilogue.',
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Epilogue' },
  },
...

  {
    ...
    guideRef: { tab: '/(tabs)/guide', label: 'View Collectibles' },
  },
...

  {
    ...
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Chapter 3' },
  },

  {
    ...
    description: 'The largest and most sophisticated city in the game, inspired by New Orleans. A cosmopolitan hub of commerce, crime, and corruption. The gang\'s Chapter 4 operations center around Angelo Bronte and the city\'s powerful crime networks.',
    ...
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Chapter 4' },
  },

  {
    ...
    description: 'A grimy, lawless trading post perched on the northeastern coast. Populated by smugglers, sailors and outlaws. Few services, lots of brawls. Key to several Chapter 6 missions as Arthur\'s story darkens.',
    ...
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Chapter 6' },
  },

  {
    ...
    category: 'towns',
    region: 'Roanoke Ridge — Northeastern Territories',
    description: 'A coal-mining town on the northeastern shore, owned lock-stock-and-barrel by Leviticus Cornwall\'s mining company. Workers live in debt to the company store. Central to the Wapiti storyline in Chapters 5 and 6.',
    services: ['General Store', 'Doctor', 'Post Office', 'Gunsmith'],
    chapter: 'Chapter 6',
    tip: 'Cornwall\'s influence here means Pinkerton agents patrol regularly — stay out of the mine foreman\'s sight if your bounty is active.',
    guideRef: { tab: '/(tabs)/walkthrough', label: 'View Chapter 6' },
  },
...

  {
    ...
    guideRef: { tab: '/(tabs)/guide', categoryId: 'legendary_animals', label: 'View Hunting' },
  },

  {
    ...
    description: 'A ghostly white bison that roams the frozen shores of Lake Isabella in the far northwest. Extremely rare and found only in the harshest conditions. Its pelt and horn craft the rare Legendary White Bison Coat.',
    chapter: 'Chapters 2–6',
...

  {
    ...
    chapter: 'Chapters 2–6',
    tip: 'The wolf uses pack hunting behavior even alone — watch all directions. Poison arrows slow it down dramatically before you land the killing shot.',
    guideRef: { tab: '/(tabs)/guide', categoryId: 'legendary_animals', label: 'View Hunting' },
  },

  {
    ...
    chapter: 'Chapters 2–6',
    tip: 'The moose is surprisingly fast when spooked — track using Eagle Eye and position upwind. A single well-placed shot to the head with a rifle is most effective.',
    guideRef: { tab: '/(tabs)/guide', categoryId: 'legendary_animals', label: 'View Hunting' },
  },
...

  {
    ...
    chapter: 'Chapters 4–6 (unlocks after 9 Hunting Challenges)',
    tip: 'Complete at least 9 Master Hunter Challenges first or the Panther will not spawn. Move slowly through the area — it will ambush you from vegetation.',
    guideRef: { tab: '/(tabs)/guide', categoryId: 'challenges_hunter', label: 'View Challenges' },
  },
...

  {
    ...
    guideRef: { tab: '/(tabs)/guide', categoryId: 'hideouts', label: 'View Hideouts' },
  },
...

  {
    ...
    chapter: 'Chapters 2–4',
    tip: 'The fence here carries unique items not found elsewhere early in the game. Keep your bounty low when visiting — the local gang will turn hostile if you cause trouble.',
    guideRef: { tab: '/(tabs)/guide', categoryId: 'hideouts', label: 'View Hideouts' },
  },

  {
    ...
    description: 'A fortified outpost held by the Del Lobo gang deep in New Austin\'s desert. A classic Wild West siege location with high stone walls. Central to several Epilogue missions as John Marston reckons with the remnants of his outlaw past.',
    chapter: 'Epilogue',
    tip: 'Assault Fort Mercer only during Epilogue missions — the Del Lobos are numerous and heavily armed. Use the gatehouse approach rather than climbing the walls.',
    guideRef: { tab: '/(tabs)/guide', categoryId: 'hideouts', label: 'View Hideouts' },
  },
];
